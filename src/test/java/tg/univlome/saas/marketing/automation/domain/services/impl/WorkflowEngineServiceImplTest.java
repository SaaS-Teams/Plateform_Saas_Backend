...
class WorkflowEngineServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        engineService = new WorkflowEngineServiceImpl(executionRepository, emailService, objectMapper, producerService);
    }
    ...
    void processStep_shouldHandleEmailActionAndCallProducerForNextStep() {
        ...
        // 3. Check ProducerService was called exactly 1 time with nextStepId
    ...
    void processStep_shouldSetFailedStatusWhenNodeDoesNotExist() {
        ...
        // Then
        // Check status is updated to FAILED because node was not found (throws Exception inside)
