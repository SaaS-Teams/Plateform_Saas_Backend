...
@RestController
@RequestMapping("/contacts/{contactTrackingId}/consent-logs")
@RequiredArgsConstructor
@Tag(name = "Logs de Consentement (RGPD)", description = "API de consultation"
        + " de l'historique " 
                + "des consentements (lecture seule)")
