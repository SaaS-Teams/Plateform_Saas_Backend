...
public class SegmentServiceImpl implements SegmentService {
    ...
    public void addContactToSegment(UUID contactTrackingId, UUID segmentTrackingId) {
        if (contactSegmentRepository.existsByContactTrackingIdAndSegmentTrackingId(contactTrackingId, segmentTrackingId)) {
    ...
    public void removeContactFromSegment(UUID contactTrackingId, UUID segmentTrackingId) {
        contactSegmentRepository.deleteByContactTrackingIdAndSegmentTrackingId(contactTrackingId, segmentTrackingId);
    }
    ...
    public Page<ContactResponse> getContactsBySegment(UUID segmentTrackingId, Pageable pageable) {
        ...
        Page<ContactSegment> liaisons = contactSegmentRepository.findBySegmentTrackingId(segmentTrackingId, pageable);
